...
public class CloudSimExample7 {
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      final List<DatacenterBroker> brokerList = new LinkedList<DatacenterBroker>();
      ...
      for (DatacenterBroker b : brokerList)
        newList.addAll(b.getCloudletReceivedList());
  ...
  private static void printCloudletList(List<Cloudlet> list) {
    ...
    Log.printLine("Cloudlet ID" + indent + "STATUS" + indent + "Data center ID"
        + indent + "VM ID" + indent + indent + "Time" + indent + "Start Time"
        + indent + "Finish Time");
